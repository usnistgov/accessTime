...
class AudioTest(unittest.TestCase):
    ...
    def test_basic(self):
        ...
        audio_file=io.BytesIO(pkgutil.get_data('mcvqoe.hardware','audio_clips/test.wav'))
        ...
        ap=mcvqoe.hardware.AudioPlayer(fs=fs_dev,rec_chans=1,playback_chans=1)
    ...
    def test_start_signal(self):
        ...
        ap=mcvqoe.hardware.AudioPlayer(fs=fs_dev,rec_chans=2,playback_chans=2,start_signal=True)
