    ...
    for dat in data_dirs:
        ...
        if os.path.exists(src):
                ...
                for dir in sset:
                    ...
                    if os.path.isdir(sname):
                        ...
                        if ext == ".zip":
                            ...
                            # no, print a message
                            print(
                                f"Skipping '{sname}' it is not a directory or .zip file",
                                flush=True,
                            )
            ...
            if bd and not dat.startswith(noback_prefix):
                ...
                if cpy:
                    print(
                        "\t" + "Backing files up from '" + dest + "' to '" + src + "'"
                    )
                    ...
                    print(
                        "\t" + "No new files found to copy to '" + src + "'", flush=True
                    )
            elif cull:
                    ...
                    try:
                        ...
                        if age.days > sunset:
                            ...
                            if os.path.isdir(fullname):
                                # print message
                                print(
                                    "Deleting old directory '" + fullname + "'",
                                    flush=True,
                                )
                                ...
                                # print message
                                print(
                                    "Deleting old file '" + fullname + "'", flush=True
                                )
                                # delete file
                                os.remove(fullname)
                    except ValueError:
                        print(
                            "Unable to parse date in file '"
                            + os.path.join(src, f)
                            + "'",
                            flush=True,
                        )
